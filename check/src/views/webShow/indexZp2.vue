  ...
  <div class="question">
    <el-row>
      ...
      <el-col class="content">
        ...
        <el-col class="toptic-title"> 政治建设 </el-col>
        <el-col
          class="list"
        ...
        <el-col class="toptic-title" style="margin-top: 0.5rem">
          思想建设
        </el-col>
        <el-col
          class="list"
