...
<script>
import { updateStationWeight } from "@/api/score/score";
import qs from "qs";
export default {
  data() {
    return {
  ...
  methods: {
    ...
    //修改评分人
    editSubmit() {
      let totalScore = this.form.aratio +
        this.form.bratio +
        this.form.cratio +
        this.form.dratio +
        this.form.eratio +
      ...
      let data = {
        ...
        data.aratio2 = this.form.aratio,
        data.bratio2 = this.form.bratio,
        data.cratio2 = this.form.cratio,
        data.dratio2 = this.form.dratio,
        data.eratio2 = this.form.eratio,
        data.fratio2 = this.form.fratio
        
      
      new Promise((response, reject) => {
        updateStationWeight(qs.stringify(data))
          .then(response => {
