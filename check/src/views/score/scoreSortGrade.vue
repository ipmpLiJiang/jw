<template>
  <div>
    <h4 class="title">
      <router-link to="/home"><span>首页</span></router-link><i class="el-icon-arrow-right"></i>评分排序汇总
    </h4>
    <el-row class="search">
      <el-col>
        <el-form
...
import { getSortList } from "@/api/score/score";
import qs from "qs";
export default {
  data() {
    return {
  ...
  methods: {
    ...
    getList() {
      ...
      new Promise((response, reject) => {
        getSortList(qs.stringify(params))
          .then((response) => {
