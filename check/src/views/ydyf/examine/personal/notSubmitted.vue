...
export default {
  ...
  methods: {
    ...
    editUser(row) {
      ...
      this.modificationForm.partyCommitteesId = row.partyCommitteesId;
      this.modificationForm.generalBranchId = row.generalBranchId;
      this.modificationForm.branchId = row.branchId;
