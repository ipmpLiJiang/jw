<template>
  <div>
    <el-row class="content">
      ...
      <el-form ref="form" :model="form">
        ...
        <el-col :span="12">
          <el-form-item label="出生年月">
            <el-input v-model="form.date" style="width: 350px"
            disabled ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="文化程度">
            <el-input v-model="form.station" style="width: 350px"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="现聘岗位">
            <el-input v-model="form.status" style="width: 350px"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="聘用时间">
            <el-input
              v-model="form.workingTtime"
              style="width: 350px"
               clearable
        ...
        <el-col :span="12">
          <el-form-item label="从事工作">
            <el-input v-model="form.job" style="width: 350px"  clearable></el-input>
          </el-form-item>
        </el-col>
      ...
      <el-col :span="20">
        <el-button type="primary" style="margin-left: 45%">确认提交</el-button>
      </el-col>
    </el-row>
  </div>
</template>
