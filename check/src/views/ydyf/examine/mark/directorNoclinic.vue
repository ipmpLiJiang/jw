  ...
  <div class="question">
    ...
    <el-row>
      ...
      <el-col class="q-content">
        ...
        <template v-if="detailData.step == 3">
          <el-col class="toptic-title">
            党支部意见
    ...
    <el-dialog
      ...
      width="30%"
    >
      <div v-if="roleType == 4">部门负责人打分为:
        <span style="color:#409EFF;font-size:16px;">
          <span v-if="detailData.deptHeadOpinion == 1">优秀</span>
          <span v-if="detailData.deptHeadOpinion == 2">良好</span>
          <span v-if="detailData.deptHeadOpinion == 3">一般</span>
          <span v-if="detailData.deptHeadOpinion == 4">较差</span>
        </span>
      </div>
      <span
        slot="footer"
...
<script>
import { Formlist, mySbmit,editById } from "@/views/ydyf/api/Form/index";
        ...
        Formlist(this.$route.query.u_id)
          .then((response) => {
            if (response.data.code == 0) {
              ...
              if (this.detailData.step == 1 || this.detailData.step == 2) {
