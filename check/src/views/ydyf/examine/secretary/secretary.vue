    ...
    <el-row class="search">
      <el-col>
        <el-form label-width="100px" show-overflow-tooltip="true">
          ...
          <el-col :span="7">
            <el-form-item label="党支部" label-width="55px">
              <el-cascader
    ...
    <el-row class="content">
      ...
      >
        ...
        <!-- <el-table-column
          ...
          width="160"
          align="center"
          v-if="this.$store.state.YdyfRole.YdyfRole == '100'"
        >
          <template slot-scope="scope">
...
import {
  ...
  tree,
  ethicsUserList,
} from "../../../ydyf/api/secretary/secretary";
...
export default {
  ...
  methods: {
    ...
    EthicsUserList() {
      ...
      new Promise((response, reject) => {
        ethicsUserList(qs.stringify(params))
          .then((response) => {
    ...
    handleChange(val) {
      if (val.length > 0) {
        this.search.secretaryValue = val[
          val.length - 1
        ];
    ...
    //编辑确认
    redact() {
      const data = this.modificationForm;
      new Promise((response, reject) => {
    ...
    //重置按钮
    reset() {
      (this.search.userName = ""), (this.search.userId = ""),(this.search.secretaryValue=""),(this.search.personType="");
      let params = this.page;
      params.userName = this.search.userName;
      params.userId = this.search.userId;
      params.relationsId="";
