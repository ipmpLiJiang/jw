      ...
      <el-col class="q-content">
        <template>
          <el-col class="toptic-title">
            {{detailData.username}}的自我评分为：{{selfScore == 0 ? '未打分' : selfScore}}<span style="margin-left:15px;">评分等级为：{{selfScore>89 ?'优秀':selfScore>79 ?'良好':selfScore>59 ?'一般':'较差'}}</span>
        ...
        <template>
          <el-col class="toptic-title">
            部门负责人评分为：{{directorScore == 0 ? '未打分' : directorScore}} <span style="margin-left:15px;"> 部门评分等级为：{{directorScore>89 ?'优秀':directorScore>79 ?'良好':directorScore>59 ?'一般':'较差'}}</span>
        ...
        <template>
          <el-col class="toptic-title">
            党支部评分为：{{secretaryScore == 0 ? '未打分' : secretaryScore}} <span style="margin-left:15px;">评分等级为：{{secretaryScore>89 ?'优秀':secretaryScore>79 ?'良好':secretaryScore>59 ?'一般':'较差'}}</span>
    ...
    >
      <div v-if="roleType == 7">
        ...
        <div>
          ...
          >优秀</span>
          <span
            v-else-if="total>79 && total<90"
            style="color:#409EFF"
          >良好</span>
          <span
            v-else-if="total>=60 && total<80"
            style="color:#E6A23C"
          >一般</span>
          <span
            v-else-if="total<60"
