...
//    @Transactional
    ...
    @Override
    public List<Duty> queryDutyByScorringCode(String scorringCode,String scorredCode,String scoreType,String dbtype){
        return dutyMapper.queryDutyByScorringCode(scorringCode,scorredCode,scoreType,dbtype);
    }
}
